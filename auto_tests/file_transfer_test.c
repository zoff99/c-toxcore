...
uint8_t *file_resume_mem_send = NULL;
...
static void file_transfer_test(void)
{
    ...
    // -- receiver goes offline in the middle of the FT --
    printf("receiver goes offline in the middle of the FT\n");
    ...
    size_t max_iterations2 = INT16_MAX;

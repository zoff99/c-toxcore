 ...
 */
static unsigned int headstart = 930;
/**
...
ssize_t sendto(int sockfd, const void *buf, size_t len, int flags, const struct sockaddr *dest_addr,
  ...
  // fprintf(stderr, "flakynet:FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF\n");
  ...
  // fprintf(stderr, "flakynet:DDDDDDDDDDDDDDDDDDDDDDDDDDD\n");

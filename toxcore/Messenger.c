...
int getfriendcon_id(const Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    int ret = m->friendlist[friendnumber].friendcon_id;
    unlock_friendlist(m);
    return ret;
}
...
static int send_online_packet(Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    int ret = write_cryptpacket(m->net_crypto, friend_connection_crypt_connection_id(m->fr_c,
...
static int friend_received_packet(const Messenger *m, int32_t friendnumber, uint32_t number)
{
    ...
    lock_friendlist(m);
    int ret = cryptpacket_received(m->net_crypto, friend_connection_crypt_connection_id(m->fr_c,
...
int getname(const Messenger *m, int32_t friendnumber, uint8_t *name)
{
    ...
    int ret = m->friendlist[friendnumber].name_length;
    unlock_friendlist(m);
    return ret;
}
...
int m_get_statusmessage_size(const Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    int ret = m->friendlist[friendnumber].statusmessage_length;
    unlock_friendlist(m);
...
uint64_t m_get_last_online(const Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    uint64_t ret = m->friendlist[friendnumber].last_seen_time;
    unlock_friendlist(m);
...
int m_get_istyping(const Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    int ret = m->friendlist[friendnumber].is_typing;
    unlock_friendlist(m);
...
uint64_t m_get_friend_toxcore_capabilities(const Messenger *m, int32_t friendnumber)
{
    ...
    lock_friendlist(m);
    uint64_t ret = m->friendlist[friendnumber].toxcore_capabilities;
    unlock_friendlist(m);

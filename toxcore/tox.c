 ...
 */
// TODO(zoff): do it in a way that cimple check likes: typedef char fail_if_notsynced_1 [ TOX_GROUP_MAX_MESSAGE_LENGTH == GROUP_MAX_MESSAGE_LENGTH ? 1 : -1 ];

/**
 * check if TOX_MAX_CUSTOM_PACKET_SIZE in tox.h and MAX_GC_CUSTOM_PACKET_SIZE in group_common.h are equal
 */
// TODO(zoff): do it in a way that cimple check likes: typedef char fail_if_notsynced_2 [ TOX_MAX_CUSTOM_PACKET_SIZE == MAX_GC_CUSTOM_PACKET_SIZE ? 1 : -1 ];

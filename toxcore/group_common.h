...
#define MAX_GC_MESSAGE_SIZE_RAW 1372
#define GC_MESSAGE_PSEUDO_ID_SIZE 4

/**
 * keep in sync with TOX_GROUP_MAX_MESSAGE_SIZE in tox.h
 */
#define MAX_GC_MESSAGE_SIZE (MAX_GC_MESSAGE_SIZE_RAW - GC_MESSAGE_PSEUDO_ID_SIZE)
